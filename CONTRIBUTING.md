Contributing to KronicCrypto Core
============================

The KronicCrypto Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to KronicCrypto-qt
...
[Translation Process](https://github.com/KronicCryptoverse/KronicCrypto/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the KronicCrypto Core project (and related
projects such as libsecp256k1), and is not to be confused with overall KronicCrypto
Network Protocol consensus changes.

Whether a pull request is merged into KronicCrypto Core rests with the project merge
...
Patches that change KronicCrypto consensus rules are considerably more involved than
...
Where a patch set proposes to change the KronicCrypto consensus, it must have been
...
The review process is normally fairly responsive on the KronicCrypto Core repository, however
...
The project leader is the release manager for each KronicCrypto Core release.
